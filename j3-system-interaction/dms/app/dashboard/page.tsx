...
import { MOCK_DASHBOARD_SUMMARY, MOCK_ALERTS, MOCK_INCOMING_REPORTS } from '@/data/mock-data';
...
export default function DashboardPage() {
  ...
  const pendingCount = MOCK_INCOMING_REPORTS.filter(r => r.verificationStatus === VerificationStatus.PENDING_REVIEW).length;
  const criticalAlerts = MOCK_ALERTS.filter(a => a.severity === IncidentSeverity.CRITICAL && a.isActive);
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-4 gap-6">
              ...
              <div className="col-span-1 bg-[#131924] border border-orange-500/20 rounded-xl p-6 flex flex-col justify-between relative overflow-hidden">
                ...
                <span className="text-5xl font-bold text-orange-400 tracking-tight my-4">{String(pendingCount).padStart(2, '0')}</span>
              ...
              <div className="col-span-1 bg-[#131924] border border-slate-800/80 rounded-xl p-6 flex flex-col justify-between relative overflow-hidden">
                ...
                <span className="text-5xl font-bold text-red-400 tracking-tight my-4">{String(data.criticalAlerts).padStart(2, '0')}</span>
            ...
            <div className="grid grid-cols-3 gap-6">
              ...
              <div className="col-span-2 bg-[#131924] border border-slate-800/80 rounded-xl overflow-hidden relative min-h-[320px]">
                <Map {...viewState} onMove={(evt: ViewStateChangeEvent) => setViewState(evt.viewState)}
                  ...
                  <Marker longitude={80.4025} latitude={6.6828} anchor="center">
                    <div className="w-3 h-3 rounded-full border-2 border-red-500 bg-red-500/30 shadow-[0_0_20px_rgba(239,68,68,0.6)] animate-pulse" />
                  </Marker>
                  <Marker longitude={79.8538} latitude={6.935} anchor="center">
                    <div className="w-3 h-3 rounded-full border-2 border-red-500 bg-red-500/30 shadow-[0_0_20px_rgba(239,68,68,0.6)]" />
                  </Marker>
                  <Marker longitude={80.0098} latitude={7.084} anchor="center">
                    <div className="w-2.5 h-2.5 bg-orange-400 rounded-full shadow-[0_0_15px_rgba(251,146,60,0.6)]" />
                  </Marker>
                  <Marker longitude={80.3464} latitude={7.2513} anchor="center">
                    <div className="w-2.5 h-2.5 bg-orange-400 rounded-full shadow-[0_0_15px_rgba(251,146,60,0.6)]" />
                  </Marker>
                </Map>
            ...
            <div className="grid grid-cols-3 gap-6">
              ...
              <div className="col-span-2 bg-[#131924] border border-slate-800/80 rounded-xl p-6">
                ...
                <div className="space-y-2">
                  {MOCK_ALERTS.filter(a => a.isActive).slice(0, 4).map((alert) => (
