    ...
    return NextResponse.json(
      {
        ...
        filters: {
          availableProvinces: provinces.map((p: { province: string | null }) => p.province).filter(Boolean),
          availableDistricts: districts.map((d: { district: string | null }) => d.district).filter(Boolean),
          currentFilters: {
